...
export interface LiveElementSecuritySnapshot {
  connected: boolean
  visible: boolean
  occluded: boolean
  disabled: boolean
...
const ROLE_COMPATIBILITY: Record<string, Set<string>> = {
...
export function assertLiveElementSecurity(
  action: BrowserAction,
  snapshot: LiveElementSecuritySnapshot,
): void {
